...
import StyledAbcTextBoldTextInputWrapper from './styles';
...
function AbcTextBoldTextInput(props: AbcTextBoldTextInputProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextBoldTextInputWrapper> {displayComp} </StyledAbcTextBoldTextInputWrapper>
    ) : (
      <StyledAbcTextBoldTextInputWrapper>
        <FieldValueList
...
export default withConfiguration(AbcTextBoldTextInput);
