...
import StyledAbcTextCustomerGroupBooleanWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupBooleanProps extends PConnFieldProps {
...
function AbcTextCustomerGroupBoolean(props: AbcTextCustomerGroupBooleanProps) {
  const {
    getPConnect,
    value = false,
    label = '',
  ...
  if (displayMode === 'DISPLAY_ONLY') {
    return ( <StyledAbcTextCustomerGroupBooleanWrapper> {displayComponent} </StyledAbcTextCustomerGroupBooleanWrapper>);
  }

  if (displayMode === "LABELS_LEFT") {
    return (
      <StyledAbcTextCustomerGroupBooleanWrapper>
      <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupBoolean);
