...
import StyledAbcTextCustomerGroupCurrencyWrapper from './styles';
...
function AbcTextCustomerGroupCurrency(props: AbcTextCustomerGroupCurrencyProps) {
  const {
    getPConnect,
    value = 0,
    placeholder,
  ...
  if (
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledAbcTextCustomerGroupCurrencyWrapper> {displayComp} </StyledAbcTextCustomerGroupCurrencyWrapper>) ;
      }
      case 'LABELS_LEFT': {
        return (
          <StyledAbcTextCustomerGroupCurrencyWrapper>
          <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupCurrency);
