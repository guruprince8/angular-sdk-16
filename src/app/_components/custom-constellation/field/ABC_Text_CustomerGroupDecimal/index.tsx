...
// includes in bundle
import StyledAbcTextCustomerGroupDecimalWrapper from './styles';
...
function AbcTextCustomerGroupDecimal(props: AbcTextCustomerGroupDecimalProps) {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  if (['DISPLAY_ONLY', 'LABELS_LEFT', 'STACKED_LARGE_VAL'].includes(displayMode as string)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledAbcTextCustomerGroupDecimalWrapper> {displayComp} </StyledAbcTextCustomerGroupDecimalWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledAbcTextCustomerGroupDecimalWrapper>
          <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupDecimal);
