...
import StyledAbcTextCustomerGroupEmailWrapper from './styles';
...
function AbcTextCustomerGroupEmail(props: AbcTextCustomerGroupEmailProps) {
 const {
    getPConnect,
    value,
    placeholder,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupEmailWrapper>
      {displayComp}
      </StyledAbcTextCustomerGroupEmailWrapper>
    ) : (
      <StyledAbcTextCustomerGroupEmailWrapper>
...
export default withConfiguration(AbcTextCustomerGroupEmail);
