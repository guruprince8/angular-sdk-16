...
import StyledAbcTextCustomerGroupIconButtonUrlWrapper from './styles';
...
function AbcTextCustomerGroupIconButtonUrl(props: AbcTextCustomerGroupIconButtonUrlProps) {
  ...
  if (displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledAbcTextCustomerGroupIconButtonUrlWrapper> {displayComp} </StyledAbcTextCustomerGroupIconButtonUrlWrapper>
    );
  }

  return (
    <StyledAbcTextCustomerGroupIconButtonUrlWrapper>
    <div style={{ display: 'flex' }} data-testid={testId}>
      ...
      <Label style={{ margin: '0.1rem' }}>
        {' '}
        {PConnect.getLocalizedValue('State list for', '', '')}{' '}
        {PConnect.getLocalizedValue(`${countryCode}`, '', '')}{' '}
      </Label>
      <Button
        icon
      ...
      {showTable && (
        <Table
          title={PConnect.getLocalizedValue('State list', '', '')}
          columns={columns}
          data={statelist}
        />
      )}
...
export default withConfiguration(AbcTextCustomerGroupIconButtonUrl);
