...
import StyledAbcTextCustomerGroupIntegerWrapper from './styles';
...
function AbcTextCustomerGroupInteger(props: AbcTextCustomerGroupIntegerProps) {
  const {
    getPConnect,
    value,
    defaultValue,
  ...
  if (['LABELS_LEFT', 'STACKED_LARGE_VAL', 'DISPLAY_ONLY'].includes(displayMode)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledAbcTextCustomerGroupIntegerWrapper> {displayComp} </StyledAbcTextCustomerGroupIntegerWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledAbcTextCustomerGroupIntegerWrapper>
          <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupInteger);
