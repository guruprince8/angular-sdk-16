...
import StyledAbcTextCustomerGroupPercentageWrapper from './styles';
...
function AbcTextCustomerGroupPercentage(props: AbcTextCustomerGroupPercentageProps) {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupPercentageWrapper>
      {displayComp}
      </StyledAbcTextCustomerGroupPercentageWrapper>
    ) : (
      <StyledAbcTextCustomerGroupPercentageWrapper>
...
export default withConfiguration(AbcTextCustomerGroupPercentage);
