...
import StyledAbcTextCustomerGroupPhoneWrapper from './styles';
...
function AbcTextCustomerGroupPhone(props: AbcTextCustomerGroupPhoneProps) {
  const {
    getPConnect,
    value,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupPhoneWrapper>
      {displayComp}
      </StyledAbcTextCustomerGroupPhoneWrapper>
    ) : (
      <StyledAbcTextCustomerGroupPhoneWrapper>
...
export default withConfiguration(AbcTextCustomerGroupPhone);
