...
import StyledAbcTextCustomerGroupPicklistWrapper from './styles';
...
function AbcTextCustomerGroupPicklist(props: AbcTextCustomerGroupPicklistProps) {
  const {
    getPConnect,
    value,
    label,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupPicklistWrapper>
      {displayComp}
      </StyledAbcTextCustomerGroupPicklistWrapper>
    ) : (
      <StyledAbcTextCustomerGroupPicklistWrapper>
...
export default withConfiguration(AbcTextCustomerGroupPicklist);
