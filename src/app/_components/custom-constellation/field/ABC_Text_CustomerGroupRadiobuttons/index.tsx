...
import StyledAbcTextCustomerGroupRadiobuttonsWrapper from './styles';
...
function AbcTextCustomerGroupRadiobuttons(props: AbcTextCustomerGroupRadiobuttonsProps) {
  const {
    getPConnect,
    value,
    label,
  ...
  return (
    <StyledAbcTextCustomerGroupRadiobuttonsWrapper>
    <RadioButtonGroup
      {...additionalProps}
      label={label}
...
export default withConfiguration(AbcTextCustomerGroupRadiobuttons);
