...
import StyledAbcTextCustomerGroupSearchboxWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupSearchboxProps extends PConnFieldProps {
...
interface AbcTextCustomerGroupSearchboxPropsSubSet {
  selected: any;
  actualValue: any;
  isTableFormatter?: boolean;
  formatter: string;
...
const DisplayComponent = (props: AbcTextCustomerGroupSearchboxPropsSubSet) => {
...
function AbcTextCustomerGroupSearchbox(props: AbcTextCustomerGroupSearchboxProps) {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  const displayComponent = useMemo(() => {
    return <StyledAbcTextCustomerGroupSearchboxWrapper>
    <DisplayComponent {...{ selected, actualValue, isTableFormatter, formatter }} />
    </StyledAbcTextCustomerGroupSearchboxWrapper>;
...
export default withConfiguration(AbcTextCustomerGroupSearchbox);
