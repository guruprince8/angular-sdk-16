...
import StyledAbcTextCustomerGroupTextWrapper from './styles';
...
function AbcTextCustomerGroupText(props: AbcTextCustomerGroupTextProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupTextWrapper> {displayComp} </StyledAbcTextCustomerGroupTextWrapper>
    ) : (
      <StyledAbcTextCustomerGroupTextWrapper>
        <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupText);
