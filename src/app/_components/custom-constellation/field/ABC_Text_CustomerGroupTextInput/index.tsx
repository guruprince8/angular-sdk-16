...
import StyledAbcTextCustomerGroupTextInputWrapper from './styles';
...
function AbcTextCustomerGroupTextInput(props: AbcTextCustomerGroupTextInputProps) {
 const {
    getPConnect,
    placeholder,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAbcTextCustomerGroupTextInputWrapper> {displayComp} </StyledAbcTextCustomerGroupTextInputWrapper>
    ) : (
      <StyledAbcTextCustomerGroupTextInputWrapper>
      <FieldValueList
...
export default withConfiguration(AbcTextCustomerGroupTextInput);
