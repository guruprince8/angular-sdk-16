...
import AbcTextCustomerGroupDetails from './index';
...
const meta: Meta<typeof AbcTextCustomerGroupDetails> = {
  title: 'AbcTextCustomerGroupDetails',
  component: AbcTextCustomerGroupDetails,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof AbcTextCustomerGroupDetails>;
...
export const BaseAbcTextCustomerGroupDetails: Story = args => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <AbcTextCustomerGroupDetails {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </AbcTextCustomerGroupDetails>
    </>
  );
};

BaseAbcTextCustomerGroupDetails.args = {
  showLabel: true,
