...
import StyledAbcTextCustomerGroupDetailsWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface AbcTextCustomerGroupDetailsProps extends PConnFieldProps {
...
function AbcTextCustomerGroupDetails(props: AbcTextCustomerGroupDetailsProps) {
  ...
  return (
    <StyledAbcTextCustomerGroupDetailsWrapper>
...
export default withConfiguration(AbcTextCustomerGroupDetails);
