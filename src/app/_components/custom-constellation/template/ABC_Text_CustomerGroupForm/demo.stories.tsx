...
import AbcTextCustomerGroupForm from './index';
...
const meta: Meta<typeof AbcTextCustomerGroupForm> = {
  title: 'AbcTextCustomerGroupForm',
  component: AbcTextCustomerGroupForm,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof AbcTextCustomerGroupForm>;
...
export const BaseAbcTextCustomerGroupForm: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <AbcTextCustomerGroupForm {...props} {...args}>{regionAChildren}</AbcTextCustomerGroupForm>
    </>
  );
};

BaseAbcTextCustomerGroupForm.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
