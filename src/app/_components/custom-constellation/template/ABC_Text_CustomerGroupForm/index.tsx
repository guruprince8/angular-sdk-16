...
import StyledAbcTextCustomerGroupFormWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupFormProps extends PConnFieldProps {
...
function AbcTextCustomerGroupForm(props: AbcTextCustomerGroupFormProps) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledAbcTextCustomerGroupFormWrapper>
...
export default withConfiguration(AbcTextCustomerGroupForm);
