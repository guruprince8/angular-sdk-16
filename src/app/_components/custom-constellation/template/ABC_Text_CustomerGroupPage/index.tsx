...
import StyledAbcTextCustomerGroupPageWrapper from './styles';
...
// interface for props
interface AbcTextCustomerGroupPageProps extends PConnFieldProps {
...
function AbcTextCustomerGroupPage(props: AbcTextCustomerGroupPageProps) {
  ...
  return (
    ...
    <StyledAbcTextCustomerGroupPageWrapper>
    <OneColumn
      // @ts-ignore
...
export default withConfiguration(AbcTextCustomerGroupPage);
