...
// interface for props
interface AbcTextCustomerGroupTwoColumnDetailsAvatarProps extends PConnFieldProps {
...
function Avatar(props: AbcTextCustomerGroupTwoColumnDetailsAvatarProps) {
