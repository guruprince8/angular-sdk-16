...
// interface for props
interface AbcTextCustomerGroupTwoColumnDetailsOperatorProps extends PConnFieldProps {
...
function Operator(props: AbcTextCustomerGroupTwoColumnDetailsOperatorProps) {
