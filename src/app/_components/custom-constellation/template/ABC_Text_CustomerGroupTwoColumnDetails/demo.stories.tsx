...
import AbcTextCustomerGroupTwoColumnDetails from './index';
...
const meta: Meta<typeof AbcTextCustomerGroupTwoColumnDetails> = {
  title: 'AbcTextCustomerGroupTwoColumnDetails',
  component: AbcTextCustomerGroupTwoColumnDetails,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof AbcTextCustomerGroupTwoColumnDetails>;
...
export const BaseAbcTextCustomerGroupTwoColumnDetails: Story = args => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <AbcTextCustomerGroupTwoColumnDetails {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
              getChildren: () =>
                pyReviewRaw.children[1].children.map((child, index) => {
                  return {
                    getPConnect: () => ({
        ...
        />
    </AbcTextCustomerGroupTwoColumnDetails>
  );
};

BaseAbcTextCustomerGroupTwoColumnDetails.args = {
  showLabel: true,
