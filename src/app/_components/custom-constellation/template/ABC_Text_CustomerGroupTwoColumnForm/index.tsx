...
import StyledAbcTextCustomerGroupTwoColumnFormWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupTwoColumnFormProps extends PConnFieldProps {
...
function AbcTextCustomerGroupTwoColumnForm(props: AbcTextCustomerGroupTwoColumnFormProps) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    return (
      <StyledAbcTextCustomerGroupTwoColumnFormWrapper>
...
export default withConfiguration(AbcTextCustomerGroupTwoColumnForm);
