...
import StyledAbcTextCustomerGroupCaseWidgetWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupCaseWidgetProps extends PConnFieldProps {
...
function AbcTextCustomerGroupCaseWidget(props: AbcTextCustomerGroupCaseWidgetProps) {
  ...
  return (
    <StyledAbcTextCustomerGroupCaseWidgetWrapper>
    <Table
...
export default withConfiguration(AbcTextCustomerGroupCaseWidget);
