...
// interface for props
interface AbcTextCustomerGroupPageCaseWidgetOperatorProps extends PConnFieldProps {
...
function Operator(props: AbcTextCustomerGroupPageCaseWidgetOperatorProps) {
