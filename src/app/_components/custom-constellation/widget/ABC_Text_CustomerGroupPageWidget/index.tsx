...
import StyledAbcTextCustomerGroupPageWidgetWrapper from './styles';

// interface for props
interface AbcTextCustomerGroupPageWidgetProps extends PConnFieldProps {
...
function AbcTextCustomerGroupPageWidget(props: AbcTextCustomerGroupPageWidgetProps) {
  ...
  return (
    <StyledAbcTextCustomerGroupPageWidgetWrapper>
    <PegaAppAnnouncement
      heading={header}
...
export default withConfiguration(AbcTextCustomerGroupPageWidget);
