...
interface AbcTextCustomerGroupCurrencyProps extends PConnFieldProps {
...
@Component({
  selector: 'app-abc-text-customer-group-currency',
  templateUrl: './abc-text-customer-group-currency.component.html',
  styleUrls: ['./abc-text-customer-group-currency.component.scss'],
  standalone: true,
...
export class AbcTextCustomerGroupCurrencyComponent implements OnInit, OnDestroy {
  @Input() pConn$: typeof PConnect;
  @Input() formGroup$: FormGroup;

  // Used with AngularPConnect
  angularPConnectData: AngularPConnectData = {};
  configProps$: AbcTextCustomerGroupCurrencyProps;
  ...
  updateSelf(): void {
    ...
    this.configProps$ = this.pConn$.resolveConfigProps(this.pConn$.getConfigProps()) as AbcTextCustomerGroupCurrencyProps;
