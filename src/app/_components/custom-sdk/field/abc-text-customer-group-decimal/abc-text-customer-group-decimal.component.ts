...
interface AbcTextCustomerGroupDecimalProps extends PConnFieldProps {
...
@Component({
  selector: 'app-abc-text-customer-group-decimal',
  templateUrl: './abc-text-customer-group-decimal.component.html',
  styleUrls: ['./abc-text-customer-group-decimal.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class AbcTextCustomerGroupDecimalComponent implements OnInit, OnDestroy {
  @Input() pConn$: typeof PConnect;
  @Input() formGroup$: FormGroup;

  // Used with AngularPConnect
  angularPConnectData: AngularPConnectData = {};
  configProps$: AbcTextCustomerGroupDecimalProps;
  ...
  updateSelf(): void {
    ...
    this.configProps$ = this.pConn$.resolveConfigProps(this.pConn$.getConfigProps()) as AbcTextCustomerGroupDecimalProps;
