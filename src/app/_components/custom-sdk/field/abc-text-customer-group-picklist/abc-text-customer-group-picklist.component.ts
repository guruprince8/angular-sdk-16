...
interface AbcTextCustomerGroupPicklistProps extends PConnFieldProps {
...
@Component({
  selector: 'app-abc-text-customer-group-picklist',
  templateUrl: './abc-text-customer-group-picklist.component.html',
  styleUrls: ['./abc-text-customer-group-picklist.component.scss'],
  standalone: true,
...
export class AbcTextCustomerGroupPicklistComponent implements OnInit, OnDestroy {
  @Input() pConn$: typeof PConnect;
  @Input() formGroup$: FormGroup;

  // Used with AngularPConnect
  angularPConnectData: AngularPConnectData = {};
  configProps$: AbcTextCustomerGroupPicklistProps;
  ...
  updateSelf(): void {
    ...
    this.configProps$ = this.pConn$.resolveConfigProps(this.pConn$.getConfigProps()) as AbcTextCustomerGroupPicklistProps;
