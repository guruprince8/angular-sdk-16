...
interface AbcTextCustomerGroupRadiobuttonsProps extends PConnFieldProps {
...
@Component({
  selector: 'app-abc-text-customer-group-radiobuttons',
  templateUrl: './abc-text-customer-group-radiobuttons.component.html',
  styleUrls: ['./abc-text-customer-group-radiobuttons.component.scss'],
  standalone: true,
...
export class AbcTextCustomerGroupRadiobuttonsComponent implements OnInit, OnDestroy {
  @Input() pConn$: typeof PConnect;
  @Input() formGroup$: FormGroup;

  // Used with AngularPConnect
  angularPConnectData: AngularPConnectData = {};
  configProps$: AbcTextCustomerGroupRadiobuttonsProps;
  ...
  updateSelf(): void {
    ...
    this.configProps$ = this.pConn$.resolveConfigProps(this.pConn$.getConfigProps()) as AbcTextCustomerGroupRadiobuttonsProps;
