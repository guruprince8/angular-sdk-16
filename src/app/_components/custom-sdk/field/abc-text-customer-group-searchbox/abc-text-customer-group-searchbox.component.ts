...
@Component({
  selector: 'app-abc-text-customer-group-searchbox',
  templateUrl: './abc-text-customer-group-searchbox.component.html',
  styleUrls: ['./abc-text-customer-group-searchbox.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class AbcTextCustomerGroupSearchboxComponent implements OnInit, OnDestroy {
  @Input() pConn$: typeof PConnect;
  @Input() formGroup$: FormGroup;

  // Used with AngularPConnect
  angularPConnectData: AngularPConnectData = {};
  configProps$: AbcTextCustomerGroupSearchboxProps;
  ...
  async updateSelf(): Promise<void> {
    ...
    this.configProps$ = this.pConn$.resolveConfigProps(this.pConn$.getConfigProps()) as AbcTextCustomerGroupSearchboxProps;
