...
@Component({
  selector: 'app-abc-text-customer-group-two-column-details',
  templateUrl: './abc-text-customer-group-two-column-details.component.html',
  styleUrls: ['./abc-text-customer-group-two-column-details.component.scss'],
  standalone: true,
  imports: [forwardRef(() => ComponentMapperComponent)]
})
export class AbcTextCustomerGroupTwoColumnDetailsComponent implements OnInit, OnDestroy {
